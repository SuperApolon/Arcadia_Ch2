...
const ASSET_STATUS = {
  ...
  "enemies/mandragora":      false,
  "enemies/cocatris":        false,
  "enemies/orga":             false,
  "enemies/donatello":         false,
  "enemies/kevin":             false,
  "enemies/chopper_pvp":       false,
  "scenes/ch2_plaza_night":   false,
  // ── 第二章 新スプライト ────────────────────────────────────────────────────
  "sprites/kevin":           false,
  "sprites/donatello":       false,
  "sprites/sneepi":          false,
  "sprites/frank":           false,
  "sprites/liebert":         false,
  "sprites/olga":            false,
  "sprites/sin":             false,
  "sprites/aries":           false,
  "sprites/persia":          false,
  "sprites/ponkiti":         false,
  "sprites/will":            false,
...
const SPRITE_MAP = {
  ...
  "🧑‍✈️":    "sprites/frank",       // フランク
  "🏹":     "sprites/liebert",     // リーベルト
  "⚔️":     "sprites/olga",        // オルガ
  "👑":     "sprites/sin",         // シン
  "🌊":     "sprites/aries",       // アリエス
  "🌸":     "sprites/persia",      // ペルシア
  "\u{1F5E1}\uFE0F": "sprites/ponkiti",   // ポンキチ
  "\uD83D\uDDE1\uFE0F": "sprites/ponkiti",// ポンキチ（代替）
  "😤":     "sprites/will",        // ウィル
...
const SPRITE_SIZE = {
  ...
  // ── 第二章新キャラ ────────────────────────────────────────────────────────
  "🧔":           { height: 230, heroHeight: 260, offsetY:  0, fallbackSize: 50 }, // kevin
  "🎭":           { height: 240, heroHeight: 260, offsetY:  0, fallbackSize: 50 }, // donatello
  "🧙":           { height: 200, heroHeight: 240, offsetY:  0, fallbackSize: 48 }, // sneepi
  "🧑‍✈️":           { height: 235, heroHeight: 260, offsetY:  0, fallbackSize: 50 }, // frank
  "🏹":           { height: 225, heroHeight: 250, offsetY:  0, fallbackSize: 50 }, // liebert
  "⚔️":           { height: 250, heroHeight: 280, offsetY:  0, fallbackSize: 52 }, // olga
  "👑":           { height: 240, heroHeight: 260, offsetY:  0, fallbackSize: 50 }, // sin
  "🌊":           { height: 230, heroHeight: 250, offsetY:  0, fallbackSize: 50 }, // aries
  "🌸":           { height: 220, heroHeight: 245, offsetY:  0, fallbackSize: 50 }, // persia
  "\u{1F5E1}\uFE0F": { height: 220, heroHeight: 245, offsetY:  0, fallbackSize: 50 }, // ponkiti
  "😤":           { height: 170, heroHeight: 220, offsetY:  0, fallbackSize: 42 }, // will
  "🏨":           { height: 220, heroHeight: 250, offsetY:  0, fallbackSize: 50 }, // mikhail
};
...
const ENEMY_IMG_SIZE = {
  ...
  moocat:        { mode:"fixed", size: 200 },
  mandragora:    { mode:"fixed", size: 220 },
  cocatris:      { mode:"fixed", size: 240 },
  simuluu_ch2:        { mode:"auto",  pct: 85  },
  cocatris_ponki_a:    { mode:"fixed", size: 240 },
  cocatris_ponki_b:    { mode:"fixed", size: 240 },
  cocatris_ponki_c:    { mode:"fixed", size: 240 },
  pvp_donatello:       { mode:"fixed", size: 320 },
  pvp_kevin:           { mode:"fixed", size: 260 },
  pvp_chopper:         { mode:"fixed", size: 220 },
...
const SCENES = [
  ...
  // ─────────────────────────────────────────────────────────────
  { bg:["#0a1808","#184010","#283020"], loc:"エイビス平原 西", sprites:["🧑","🌸","🏹"], dl:[
    { sp:"ナレーション", t:"翌日、ペルシアから届いたメール。\n\n「ポン吉さんと今日13:00からパーティ組む事になったんですけど、\nエルツさんどうでしょうか？」\n\n気持ちに引きずられてはオルガに失礼だ。\nエルツは了承のメールを返した。" },
  ...
  { bg:["#0a1206","#1a2a0a","#100e04"], loc:"スティアルーフ 中央広場", sprites:["🧑","🧑‍🦱","👩","👦","👧","🎭","🧙","⚔️"], dl:[
    ...
    { sp:"ドナテロ", t:"「最後なんだから相手してやったらどうかね、オルガさん」" },
    { sp:"オルガ", t:"「そうだな。行くかドナテロ？」" },
  ...
  { bg:["#0a1206","#1a2a0a","#100e04"], loc:"スティアルーフ 中央広場", sprites:["🧑","🧑‍🦱","👩","👦","👧","🎭","🧙","⚔️"], dl:[
    ...
    { sp:"ウィル", t:"「おっちゃん辞めんなよ！」" },
    { sp:"スニーピィ", t:"「オルガさん、いつかお子さん大きくなったら、\nその時は家族でまたここへ戻ってきて下さいね」" },
    { sp:"ケヴィン", t:"「俺達ずっと待ってますから！」" },
    { sp:"オルガ", t:"「......ありがとう」" },
...
export default function ArcadiaCh2() {
  ...
  if (phase === "victory") {
    ...
    return (
      <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"linear-gradient(180deg,#020608 0%,#050d14 40%,#0a1420 100%)",fontFamily:"'Noto Serif JP',serif",overflow:"hidden",userSelect:"none"}}>
  ...
  if (phase === "load") return (
    <div
      style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:`linear-gradient(180deg,#020810 0%,#050d14 40%,#0a1020 100%)`,fontFamily:"'Noto Serif JP',serif",textAlign:"center",padding:32,overflow:"hidden"}}
  ...
  if (phase === "loaded" && saveFile) {
    ...
    return (
      <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:`linear-gradient(180deg,#020810 0%,#050d14 100%)`,fontFamily:"'Noto Serif JP',serif",textAlign:"center",padding:32}}>
        <style>{loadKeyframes}</style>
  ...
  if (phase === "select") {
    ...
    return (
      <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:`linear-gradient(180deg,#020810 0%,#050d14 50%,#0a1828 100%)`,fontFamily:"'Noto Serif JP',serif",overflow:"hidden"}}>
        <style>{keyframes}</style>
        <div style={{position:"absolute",inset:0,backgroundImage:"repeating-linear-gradient(0deg,transparent,transparent 2px,rgba(0,200,255,0.012) 2px,rgba(0,200,255,0.012) 4px)",pointerEvents:"none"}}/>
  ...
  if (phase === "movie") {
    ...
    return (
      <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",background:"#000",overflow:"hidden"}}>
        <style>{keyframes}</style>
        <video
          src={url}
          autoPlay
  ...
  if (phase === "end") {
    ...
    return (
      <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:`linear-gradient(180deg,#030a06 0%,#0a1a0a 50%,#0d2010 100%)`,fontFamily:"'Noto Serif JP',serif",textAlign:"center",padding:40}}>
        <style>{keyframes}</style>
  ...
  if (phase === "battle") {
    ...
    return (
      <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",background:battleBg,fontFamily:"'Noto Serif JP',serif",userSelect:"none",overflow:"hidden"}}>
        <style>{keyframes}</style>
  ...
  return (
    <div style={{position:"fixed",inset:0,width:"100dvw",height:"var(--app-height,100dvh)",display:"flex",flexDirection:"column",...bgStyle,fontFamily:"'Noto Serif JP',serif",userSelect:"none",overflow:"hidden",transition:"background 1s"}}>
      <style>{keyframes}</style>
